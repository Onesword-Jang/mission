...
- **개발 기간**: 24.11.21.(목)~24.12.3(월), 13일 간
    ...
    | 날짜 | 목표 | 비고 |
    | --- | --- | --- |
    | 11/21(목) | - 레포지토리 개설 및 초대
    - 기획
    - 역할분담, 이해도 점검(github, model 등) | 1일 |
    | 11/22(금), 23(토) | - 데이터 수집 및 전처리 | 2일 |
    | 11/24(일)~27(수) | - 챗봇 훈련 및 모델 학습 | 4일 |
    | 11/28(목)~12/2(월) | - streamlit 인터페이스 디자인
    - 챗봇 오류 개선
    - 스트림릿 오류 개선
    - 문서 작성(트러블 슈팅 등) | 5일 |
    | 12/3(화) | - 최종 점검 및 회고
...
- **개발 인원**: 4명
    ...
    | 이름(구분) | 역할 및 기여도 |
    | --- | --- |
    | 이다원(팀장) |  **-기획:** 아이디어 제안, 의견 취합
    **- 자료수집 및 전처리:** Python, Machine Learning
    **- 백엔드 개발:** 카테고리 불러오기, 대화 내용 저장(날짜별), 학습시간 기록, 프롬프트 작성, 로그인 및 회원가입 기능 등
    **- 문서작성:** SA, [LEAD.ME](http://LEAD.ME)
    **- 기타:** 로고 제작, 시스템 아키텍처 작성 등  |
    | 장한검(서기) | **- 기획:** 아이디어 제안, 팀 노션 관리
    **- 자료수집 및 전처리:** Algorithm, Data Structure
    **- 프론트엔드 개발**
    1. 메인페이지 프로그램 소개 및 세션 구분 구현(FE 공통) 
    2. 페이지별 사용자 확인
    3. 자습실 셀렉트 박스 대화창 연동(주제 선택, 질문 선택 → 질문 출력)
    4. 자습실 챗봇과 대화 UI
    **- 문서 작성**
    1. 다이어그램 작성
    2. README 개선 사항 제안  |
    | 김준기(팀원) | **- 기획:** 아이디어 제안
    **- 자료수집 및 전처리:** Deep Learning, Operating System
    **- 백엔드 개발:** 카테고리 불러오기, 대화 내용 불러오기, 프롬프트 작성, 자동 번역 기능 구현, 현재 시간 구현
    - **문서 작성:** 다이어그램, SA, Readme |
    | 전상우(팀원) | -**기획**: 아이디어 제안
    -**자료 수집 및 전처리**: Statistics, Network
    -**프론트 엔드 개발**
    1. 메인페이지 프로그램 소개 및 세션 구분 구현(공통)
    2. 멀티 페이지 기능 구현
    3. 면접실 셀렉트 박스와 대화창 연동(주제 선택, 새 질문 출력)
    4. 코드 최적화
    5. 전체 페이지 구현 기능 오작동 여부 확인 |
...
![데이터 흐름 4.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/83c75a39-3aba-4ba4-a792-7aefe4b07895/c9152b6c-fcf6-4398-b94d-19ba8848543a/%EB%8D%B0%EC%9D%B4%ED%84%B0_%ED%9D%90%EB%A6%84_4.png)
...
![흐름2.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/83c75a39-3aba-4ba4-a792-7aefe4b07895/f02a35de-1709-4592-a230-a2565411cecb/%ED%9D%90%EB%A6%842.png)
...
![발표물 아키텍처 1.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/83c75a39-3aba-4ba4-a792-7aefe4b07895/02952bc0-d5f1-4b23-913d-86abe2da6138/%EB%B0%9C%ED%91%9C%EB%AC%BC_%EC%95%84%ED%82%A4%ED%85%8D%EC%B2%98_1.png)

![화면 디자인.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/83c75a39-3aba-4ba4-a792-7aefe4b07895/5314d8eb-3c0f-4ab8-bc12-88cb98920834/%ED%99%94%EB%A9%B4_%EB%94%94%EC%9E%90%EC%9D%B8.png)
...
- **BE**
    ...
    - 사용자 정보 저장
    - 시간 정보 구현
- 자세한 내용은 [팀노션]([https://www.notion.so/teamsparta/b56a4b7a92be4401984a51bc59004046](https://www.notion.so/b56a4b7a92be4401984a51bc59004046?pvs=21)) 을 확인해주세요.
